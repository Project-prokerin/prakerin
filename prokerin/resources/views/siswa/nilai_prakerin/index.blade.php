                ...
                <div class="row mb-5">
                    ...
                    <div class="col-6">
                        <div class="mb-2 col-12 row">
                            <label for="" class="col-sm-6 col-form-label">Nilai Perusahaan</label>
                            <div class="mb-3 col-sm-6">
                                <label for="" class="col-form-label">100</label>
                            </div>
                        </div>
                        <div class="mb-2 col-12 row">
                            <label for="" class="col-sm-6 col-form-label">Aspek Yang Dinilai</label>
                            <div class="mb-3 col-sm-6">
                                <label for="" class="col-form-label">100</label>
                            </div>
                        </div>
                        <div class="mb-2 col-12 row">
                            <label for="" class="col-sm-6 col-form-label">Keterangan</label>
                            <div class="mb-3 col-sm-6">
                                <label for="" class="col-form-label">A</label>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-5">
                                    <div class="col-12">
                                        <div class="">
                                            <div class="">
                                                <h6 class="mb-3">A. Pelaksanaan</h6>
                                            </div>
                                            <table class="ml-5 table table-sm table-bordered">
                                                <thead class="text-center">
                                                <tr>
                                                    <th colspan="2">No.</th>
