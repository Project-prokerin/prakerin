    ...
    @csrf
        <li class="media mt-4">
          ...
          <div class="media-body ml-3" style="margin-top: -8px;">
              ...
              <input type="password" style="width: 230px; margin-top: -8px;" class="form-control @error('old_pass') is-invalid @enderror" name="old_pass">
                @error('old_pass')
        ...
        <li class="media mt-3">
            ...
            <div class="media-body ml-3" style="margin-top: -8px;">
                ...
                <input type="text" style="width: 230px; margin-top: -8px;" class="form-control" name="new_pass">
                @error('new_pass')
                    <div class="invalid_feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <li class="media mt-3">
          ...
          <div class="media-body ml-3" style="margin-top: -8px;">
                ...
                <input type="text" style="width: 230px; margin-top: -8px;" class="form-control" name="new_pass2">
                @error('new_pass2')
                    <div class="invalid_feedback">{{ $message }}</div>
                @enderror
          </div>
