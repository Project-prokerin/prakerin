            ...
            <form action="{{ route('penelusuran_tamantan.post') }}" method="POST" id="form">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-6">
                        <div class="mb-3 col-lg-10">
                            ...
                            <select name="id_alumni"
                                ...
                                <option value="{{$alum->id}}"
                                    {{(old('id_alumni', $pen->id_alumni) == $alum->id) ? 'selected' : ''}}>
                                    {{$alum->nama}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3 col-lg-10">
                            <label>Kelas</label>
                            <input type="text" name="kelas" value="{{ old('kelas', $pen->alumni_siswa->kelas) }}"
                                class="form-control input_KJ kelas" disabled>
                        </div>
                        <div class="mb-3 col-lg-10">
                            <label>Jurusan</label>
                            <input type="text" name="jurusan" value="{{ old('kelas', $pen->alumni_siswa->jurusan) }}"
                                class="form-control input_KJ jurusan" disabled>
                        </div>
                        <div class="mb-3 col-lg-10">
                            <label>Tahun lulus</label>
                            <input type="text" name="tahun_lulus"
                                value="{{ old('kelas', $pen->alumni_siswa->tahun_lulus) }}"
                                class="form-control input_KJ tahun_lulus" disabled>
                        </div>
                        <div class="mb-3 col-lg-10">
                            <label>Status</label>
                            <select id="status" name="status"
                                ...
                                <option {{ ($pen->status == 'bekerja') ? 'selected' : '' }} value="bekerja">Bekerja
                                </option>
                                <option {{ ($pen->status == 'kuliah') ? 'selected' : '' }} value="kuliah">Kuliah
                                </option>
                                <option {{ ($pen->status == 'Wirausaha') ? 'selected' : '' }} value="Wirausaha">
                                    Wirausaha</option>
                                <option {{ ($pen->status == 'Bekerja dan Kuliah') ? 'selected' : '' }}
                                    value="Bekerja dan Kuliah">Bekerja & Kuliah</option>
                                <option {{ ($pen->status == 'Wirausaha dan Kuliah') ? 'selected' : '' }}
                                    value="Wirausaha dan Kuliah">Wirausaha & Kuliah</option>
                            </select>
                    ...
                    <div class="col-6">
                        ...
                        <div class="mb-3 col-lg-10" id="namaperusahaan" hidden>
                            ...
                            <div class="mb-3">
                                <input type="text" name="nama_perusahaan" id="valid_namaperusahaan"
                                    ...
                                    value="{{ old('nama_perusahaan', empty($pen->nama_perusahaan) ? '' : $pen->nama_perusahaan) }}">
                        ...
                        {{-- tutup --}}
                        <span id="cek" data-status="{{ $pen->satus }}"></span>
                        {{-- kuliah --}}
        ...
        function validation_form(status = null) {
            ...
            switch (status) {
                ...
                case 'Bekerja dan Kuliah':
                    ...
                    if (namakampus && alamatkampus && tahunmasuk && namaperusahaan && alamatperusahaan &&
                        tahunkuliah && nama && status) {
                        return 'submit';
                    }
                    break;
