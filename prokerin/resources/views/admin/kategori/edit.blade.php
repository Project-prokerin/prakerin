...
<div class="card" style="">
    <div class="card-header">
        <h4 class="pt-2 card-title"><i class="fas fa-th"></i> Edit Data Kategori</h4>
    </div>
    <div class="card-body">
        <form action="{{ route('kategori.update',$detail->id) }}" method="post">
            @method('PUT')
            @csrf
            <div class="row mb-5">
                {{-- card col 1 --}}
                <div class="col-6">
                    <div class="mb-2 col-12 row">
                        ...
                        <div class="mb-3 col-8">
                            <input type="text" name="aspek_yang_dinilai" value="{{$detail->aspek_yang_dinilai}}" class="form-control  @error('aspek_yang_dinilai')  is-invalid  @enderror">
                ...
                <div class="mb-2 col-12 row">
                    ...
                    <div class="mb-3 col-8">
                        <select name="keterangan" id="keterangan"
                            ...
                            <option value="Nilai Sekolah" {{((old('keterangan') ?? $detail->keterangan) == "Nilai Sekolah") ? 'selected' : ''}}>Nilai Sekolah</option>
                            <option value="Nilai Perusahaan" {{((old('keterangan') ?? $detail->keterangan) == "Nilai Perusahaan") ? 'selected' : ''}}>Nilai Perusahaan</option>
