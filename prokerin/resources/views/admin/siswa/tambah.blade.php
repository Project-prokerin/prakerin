    ...
    <div class="container">
        <div class="card-body mt-3">
            ...
            <form class="d-flex flex-row-reverse" style="margin-top: -36px;">
                ...
                <div>
                    <button type="button" class="btn btn-danger"><i class="fas fa-window-close mr-2"></i>Cancel</button>
                </div>
                &nbsp;&nbsp;&nbsp;
                <div>
                    <button type="button" class="btn btn-primary"><i class="fas fa-check-square mr-2"></i>Submit</button>
                </div>
            </form>
        </div>
    </div>
