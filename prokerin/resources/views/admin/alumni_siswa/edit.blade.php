            ...
            <div class="row">
                ...
                <div class="">
                    <div class="" style="height: auto;">
                        <div class="card-body">
                        <form action="{{ route('alumni_siswa.update', $alumni->id) }}" method="POST" class="input">
                            @csrf
                            @method('put')
                            <div class="mb-3">
                                ...
                                @error('nama') is-invalid @enderror" placeholder="nama" value="{{ old('nama',$alumni->nama) }}">
                                </div>
                                @error('nama')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <input type="text" name="kelas" class="form-control @error('kelas')
                                        is-invalid
                                    @enderror" placeholder="kelas" value="{{ old('kelas', $alumni->kelas) }}">
                                </div>
                                @error('kelas')
                                    <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <input class="form-control  @error('jurusan')
                                        is-invalid
                                    @enderror"  name="jurusan" value="{{ old('jurusan', $alumni->jurusan) }}">
                                </div>
                                @error('jurusan')
                                    <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <input type="text" class="form-control @error('tahun_lulus')
                                        is-invalid
                                    @enderror" name="tahun_lulus" placeholder="Masukan nomor telepone" value="{{ old('tahun_lulus', $alumni->tahun_lulus) }}">
                                </div>
                                @error('tahun_lulus')
                                    <div class="invalid-feedback">
                                            {{ $message }}
