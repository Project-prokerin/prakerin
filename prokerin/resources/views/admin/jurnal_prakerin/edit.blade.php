...
<meta name="csrf-token" content="{{ csrf_token() }}">
        ...
        <div class="breadcrumb-item"><a href="{{ route('jurnal.index') }}"><i class="far fa-newspaper"></i> JURNAL PRAKERIN</a></div>
            ...
            <div class="col-sm-6">
                    ...
                    <div class="row checkbox"  >
                            <div class="form-check form-check-inline box-jurnal">
                                    <input class="form-check-input mess " {{(old('mess') ?? $jurnalPrakerin->mess) == 'iya' ? 'checked' : ''}}   data_id="mess" type="checkbox" id="" name="mess"  value="iya">
                                    <label class="form-check-label" for="mess">Iya</label>
                                </div>
                                <div class="form-check form-check-inline box-jurnal">
                                    <input class="form-check-input mess" {{(old('mess') ?? $jurnalPrakerin->mess) == 'tidak' ? 'checked' : ''}}  data_id="mess" type="checkbox" id="" name="mess"  value="tidak">
