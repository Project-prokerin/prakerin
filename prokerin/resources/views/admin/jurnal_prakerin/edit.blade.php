...
<meta name="csrf-token" content="{{ csrf_token() }}">
        ...
        <div class="breadcrumb-item"><a href="{{ route('jurnal.index') }}"><i class="far fa-newspaper"></i> DATA JURNAL PRAKERIN</a></div>
...
<div class="card-header  bold " style="margin-bottom: -50px; ">
     ...
     <form action="{{route('jurnal.update',$jurnalPrakerin->id)}}" method="POST" id="form">
    ...
    <div class="">
            ...
            <div class="col-sm-6">
                    ...
                    <div class="row checkbox"  >
                            ...
                            <div class="form-check form-check-inline box-jurnal">
                                    ...
                                    <input class="form-check-input mess " {{(old('mess',$jurnalPrakerin->fasilitas_prakerin->mess) ) == 'iya' ? 'checked' : ''}}   data_id="mess" type="checkbox" id="" name="mess"  value="iya">
                                ...
                                <div class="form-check form-check-inline box-jurnal">
                                    ...
                                    <input class="form-check-input mess" {{(old('mess',$jurnalPrakerin->fasilitas_prakerin->mess) ) == 'tidak' ? 'checked' : ''}}  data_id="mess" type="checkbox" id="" name="mess"  value="tidak">
            ...
            <div class="col-sm-6">
                    ...
                    <div class="row checkbox">
                            ...
                            <div class="form-check form-check-inline box-jurnal">
                                    ...
                                    <input class="form-check-input bus_antar_jemput"  {{ (old('bus_antar_jemput',$jurnalPrakerin->fasilitas_prakerin->buss_antar_jemput)=='iya') ? 'checked' : '' }} type="checkbox" id="" name="buss_antar_jemput" value="iya">
                                ...
                                <div class="form-check form-check-inline box-jurnal">
                                    ...
                                    <input class="form-check-input bus_antar_jemput"  {{ (old('bus_antar_jemput',$jurnalPrakerin->fasilitas_prakerin->buss_antar_jemput)=='tidak') ? 'checked' : '' }} type="checkbox" id="" name="buss_antar_jemput" value="tidak">

                                    <label class="form-check-label" for="buss_antar_jemput">Tidak</label>
            ...
            <div class="col-sm-6">
                    ...
                    <div class="row checkbox">
                            ...
                            <div class="form-check form-check-inline box-jurnal">
                                    ...
                                    <input class="form-check-input makan_siang"  {{ (old('makan_siang',$jurnalPrakerin->fasilitas_prakerin->makan_siang)=='iya') ? 'checked' : '' }} type="checkbox" id="" name="makan_siang" value="iya">
                                ...
                                <div class="form-check form-check-inline box-jurnal">
                                    ...
                                    <input class="form-check-input makan_siang"  {{ (old('makan_siang',$jurnalPrakerin->fasilitas_prakerin->makan_siang)=='tidak') ? 'checked' : '' }} type="checkbox" id="" name="makan_siang" value="tidak">
            ...
            <div class="col-sm-6">
                    ...
                    <div class="row checkbox">
                            ...
                            <div class="form-check form-check-inline box-jurnal">
                                    ...
                                    <input class="form-check-input intensif" {{ (old('intensif',$jurnalPrakerin->fasilitas_prakerin->intensif)=='iya') ? 'checked' : '' }} type="checkbox"  id="" name="intensif" value="iya">
                                ...
                                <div class="form-check form-check-inline box-jurnal">
                                    ...
                                    <input class="form-check-input intensif" {{ (old('intensif',$jurnalPrakerin->fasilitas_prakerin->intensif)=='tidak') ? 'checked' : '' }} type="checkbox" id="" name="intensif" value="tidak">
        ...
        {{-- <div class=""> --}}
            ...
            <select name="id_siswa" class="form-control  @error('id_siswa')  is-invalid  @enderror select2">
                ...
                <option value="{{$jurnalPrakerin->id_siswa}}" selected>{{$jurnalPrakerin->siswa->nama_siswa}}</option>
...
<div class="col-sm-6">
    ...
    <div class="">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control daterange-cus @error('hari_pelaksanaan') is-invalid @enderror" value="{{ old('hari_pelaksanaan', $jurnalPrakerin->hari_pelaksanaan->format('Y-m-d')) }}" name="hari_pelaksanaan" id="">
