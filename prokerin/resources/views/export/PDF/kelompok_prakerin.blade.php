        ...
        <div >
            <div>
                {{-- <img  alt="" style="width: 150px; height: 150px;"> --}}
                    <img  class="logo" src="https://pbs.twimg.com/profile_images/753761871300218880/OC5yL5QZ.jpg"   alt="" srcset="">
            </div>
            <div >
                    <h2 class="font4" style="margin-top: -30px; margin-left: -20px; text-align:center;       font-weight: lighter;">YAYASAN SETYA BHAKTI</b></h2>
                    <h1 class="font2" style="margin-top: -25px; margin-left: -10px; text-align:center;"><span>SMK TARUNA BHAKTI</span></h1>
                    <h5 style="margin-top: -25px; margin-right: -5px; text-align:center; "><b>TERAKREDITASI: "A" No : 02.00/203/BAN-SM/XII/2018</b></h5>
                    <h5 style="margin-top: -25px; margin-right: -5px; text-align:center; "><b>Izin No: 421.4/1150/DISDIK/2004 - NPSN: 20229232</b></h5>
                    <h6 style="margin-top: -20px; margin-right: -5px; text-align:center;" class="font5">KOMPETENSI KEAHLIAN:</h6>
                    <h6 style="margin-top: -25px; margin-right: -5px; text-align:center;" class="font5">PODUKSI DAN SIARAN PROGRAM TELEVISI | TEKNIK ELEKTRONIKA INDUSTRI</h6>
                    <h6 style="margin-top: -25px; margin-right: -5px; text-align:center;" class="font5">TEKNIK KOMPUTER DAN JARINGAN | MULTIMEDIA | REKAYASA PERANGKAT LUNAK</h6>
            </div>
            <div style="clear: both;">
              <h6 style="margin-top: -20px;  text-align:center;" class="font5">JALAN PEKAPURAN CURUG CIMANGGIS DEPOK 16953 TELP.:(021) 8744810 FAKS.:(021) 87743374 </h6>
              <h5 style="margin-top: -25px;  text-align:center;" class="font5"><b style="font-size: 15px; font-weight: bold;">Website : </b> <a href="https://smktarunabhakti.net/">https://smktarunabhakti.net/</a> <b style="font-size: 15px; font-weight: bold;"> &nbsp;E-mail :</b> <a href="taruna@smktarunabhakti.net " >taruna@smktarunabhakti.net</a></h5>
              <hr class="hr-1">
              <hr class="hr-2">
              <hr class="hr-3">
              <h6 class="font6" style="margin-top: 1px; font-size: 14px;">No     &nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;  063/421.5-SMK.TB/HUBIN/PRAKERIN/II/2021</h6>
              <h6 class="font6" style="margin-top: -32px; font-size: 14px; ">Lamp :&nbsp; -</h6>
              <h6 class="font6" style="margin-top: -32px; font-size: 14px; ">Hal &nbsp;&nbsp;&nbsp; :&nbsp; <a href="" style=" color:black; font-weight: bolder;">Pelaksanaan Prakerin</a></h6>
              <h6 class="font6" style="font-weight: 300px;font-size: 14px; margin-top: -15px;">Kepada</h6>
              <h6 class="font6" style="font-weight: 300px;font-size: 14px; margin-top: -25px; ">Yth. &nbsp;&nbsp;&nbsp;   <b style="font-weight: bolder;">Bapak / Ibu Pimpinan PT Abadiri Paradipa  (ABDIRA)</b> </h6>
              <h6 class="font6" style="font-weight: 300px;font-size: 14px; margin-top: -30px; "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   jln Gama Setia Barat 2 No 8 Bhakti Jaya Kec. Sukmajaya Kota Depok 16418 </h6>
              <h6 class="font6" style="font-weight: 300px;font-size: 14px; margin-top: -30px; "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Di </h6>
              <h6 class="font6" style="font-weight: 300px;font-size: 14px; margin-top: -30px; "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Tempat </h6>
              <h6 class="font6" style="font-weight: 300px;font-size: 14px; margin-top: -25px; "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Dengan hormat, </h6>
              <div class="container">
                <div style="width: 660px;">
                  <p style="font-size: 14px; margin-top: -25px; " class="font6">
                    Salam sejahtera kami sampaikan semoga Bapak/Ibu selalu dalam keadaaan sehat wal'afiat serta selalu diberikan kelancaran dalam menjalankan
                      segala aktivitasnya.
                  </p>
                  <p style="font-size: 14px;  " class="font6">
                    Dalam rangka pelaksanaan salah satu program SMK Taruna Bhakti di bidang Hubungan Industri yang salah satunya adalah pelaksanaan <b>Praktek Kerja Industri (PRAKERIN)</b> 
                ...
                <div class="container-table">
                  ...
                  <div>
                    <p style="font-size: 14px; margin-top: 3px; " class="font6">
                      Besar harapan kami kepada saudara agar membimbing serta mendidik peserta didik kami dalam pelaksanaan prakerinnya agar bisa menjadi insan yang bermutu  dan berkualitas.
                      <br>
